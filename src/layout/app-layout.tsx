...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'researcher', 'editor', 'viewer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Csv File', path: '/csv-files', entity: 'csv_file', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Group', path: '/groups', entity: 'group', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    { name: 'Theme', path: '/themes', entity: 'theme', service: AccessServiceEnum.PROJECT, icon: FiLayout },
    {
      name: 'Theme Group',
      path: '/theme-groups',
      entity: 'theme_group',
