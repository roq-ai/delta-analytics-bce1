...
import { getCsvFileById } from 'apiSdk/csv-files';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Csv File Detail View
          </Text>
          {hasAccess('csv_file', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/csv-files/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('theme', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/themes/create?csv_file_id=${data?.id}`}>
